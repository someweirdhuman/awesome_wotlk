...
ACVar.CVARS = {
    [L.CATEGORY_CAMERA] = {
        ...
        { name = "cameraIndirectVisibility", label = L.CVAR_LABEL_CAMERA_INDIRECT_VISIBILITY, type = "mode", modes = { {value = 0, label = L.MODE_LABEL_CAMERA_DEFAULT}, {value = 1, label = L.MODE_LABEL_CAMERA_CUSTOM} } },
        { name = "cameraIndirectAlpha", label = L.CVAR_LABEL_CAMERA_INDIRECT_ALPHA, type = "slider", min = 0.6, max = 1, step = 0.05, default = 0.6 },
        { hidden = true, name = "cameraIndirectOffset", label = L.CVAR_LABEL_CAMERA_INDIRECT_OFFSET , desc = L.DESC_CAMERA_SPEED, type = "slider", min = 0, max = 10, step = 1, default = 10 },
    },
