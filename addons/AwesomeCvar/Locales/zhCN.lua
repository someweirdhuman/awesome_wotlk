...
if GetLocale() == "zhCN" then
    ...
    L.CVAR_LABEL_SPELL_PROJECTION_MODE = "法术投射模式"
	L.CVAR_LABEL_SPELL_PROJECTION_MAX_RANGE = "法术投射最大距离"
	L.CVAR_LABEL_SPELL_PROJECTION_HORIZONTAL_BIAS = "法术投射水平偏移"
	L.CVAR_LABEL_CAMERA_INDIRECT_VISIBILITY = "相机间接可见性"
	L.CVAR_LABEL_CAMERA_INDIRECT_ALPHA = "相机间接透明度"
	L.CVAR_LABEL_CAMERA_INDIRECT_OFFSET = "相机间接偏移"

	L.DESC_CAMERA_SPEED = ""
	L.DESC_ZERO_TO_DISABLE = "0 = 禁用"
    ...
    L.MODE_LABEL_PROJECTION_DEFAULT = "默认法术投射（3.3.5）"
    L.MODE_LABEL_PROJECTION_CUSTOM = "自定义法术投射（Classic）"
	L.MODE_LABEL_CAMERA_DEFAULT = "默认相机"
	L.MODE_LABEL_CAMERA_CUSTOM = "自定义相机"
end