...
if GetLocale() == "zhTW" then
    ...
    L.CVAR_LABEL_SPELL_PROJECTION_MODE = "法術投射模式"
	L.CVAR_LABEL_SPELL_PROJECTION_MAX_RANGE = "法術投射最大距離"
	L.CVAR_LABEL_SPELL_PROJECTION_HORIZONTAL_BIAS = "法術投射水平偏移"
	L.CVAR_LABEL_CAMERA_INDIRECT_VISIBILITY = "相機間接可見性"
	L.CVAR_LABEL_CAMERA_INDIRECT_ALPHA = "相機間接透明度"
	L.CVAR_LABEL_CAMERA_INDIRECT_OFFSET = "相機間接偏移"

	L.DESC_CAMERA_SPEED = ""
	L.DESC_ZERO_TO_DISABLE = "0 = 停用"
	...
	L.MODE_LABEL_CAMERA_DEFAULT = "預設相機"
	L.MODE_LABEL_CAMERA_CUSTOM = "自訂相機"
end