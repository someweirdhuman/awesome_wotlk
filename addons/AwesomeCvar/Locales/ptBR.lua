...
if GetLocale() == "ptBR" then
	...
	L.CVAR_LABEL_CAMERA_INDIRECT_OFFSET = "Deslocamento indireto da câmera"
	...
	L.MODE_LABEL_CAMERA_DEFAULT = "Câmera padrão"
	L.MODE_LABEL_CAMERA_CUSTOM = "Câmera personalizada"
end