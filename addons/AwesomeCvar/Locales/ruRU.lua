...
if GetLocale() == "ruRU" then
	...
	L.CVAR_LABEL_CAMERA_INDIRECT_OFFSET = "Косвенное смещение камеры"
	...
	L.MODE_LABEL_CAMERA_DEFAULT = "Камера по умолчанию"
	L.MODE_LABEL_CAMERA_CUSTOM = "Пользовательская камера"
end
