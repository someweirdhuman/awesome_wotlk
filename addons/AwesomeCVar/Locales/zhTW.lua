...
if GetLocale() == "zhTW" then
    ...
    L.CVAR_LABEL_NAMEPLATE_RECHECK_TRESHOLD = "姓名板重檢閾值"
    ...
    L.CVAR_MSDF_MODE = "字體渲染模式（需要重新啟動遊戲） |cffff0000(需要重新啟動)|r"
    ...
    L.DESC_NAMEPLATE_RECHECK_TRESHOLD = "姓名板在更新之前必須相對於其先前位置移動的最小距離，有助於防止跳動。"
